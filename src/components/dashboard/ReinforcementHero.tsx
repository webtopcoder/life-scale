...
type HeroType = 'speed' | 'score' | 'category' | 'momentum';
...
interface ReinforcementHeroProps {
  type: HeroType;
}

const ReinforcementHero = ({ type }: ReinforcementHeroProps) => {
...
export default ReinforcementHero;
