...
import { get888TtSessionId, useFunnel888Tt } from '@/context/Funnel888TtContext';
...
export type EmailCaptureView888TtProps = {
  /** Skip SET_STAGE checkout — user is already on checkout */
  embeddedInCheckout?: boolean;
};

/**
 * Onboarding-888Tt-only email capture screen. Its presentation can evolve
 * without changing any other funnel.
 */
export function EmailCaptureView888Tt({ embeddedInCheckout = false }: EmailCaptureView888TtProps) {
  ...
  const handleContinue = () => {
    ...
    syncKlaviyoQuizLeadInBackground({
      ...
      logPrefix: '[EmailCaptureView888Tt]',
    });
  };
