...
import ReinforcementHero888 from './ReinforcementHero888';

export interface ReinforcementScreen888Props {
        ...
        >
          {!isMemory && (
            <motion.div
              ...
              className="mb-8"
            >
              <ReinforcementHero888 type={type} />
            </motion.div>
          )}
...
export default ReinforcementScreen888;
