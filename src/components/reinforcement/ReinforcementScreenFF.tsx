...
import ReinforcementHeroFF from './ReinforcementHeroFF';
import { useFFIntl } from '@/i18n/ff';

export interface ReinforcementScreenFFProps {
...
export default ReinforcementScreenFF;
