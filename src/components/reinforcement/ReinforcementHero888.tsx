...
import fingerprintAnim from '@/assets/blue-fingerprint-888.svg';
...
interface ReinforcementHero888Props {
  type: HeroType;
}

const ReinforcementHero888 = ({ type }: ReinforcementHero888Props) => {
...
export default ReinforcementHero888;
