...
import fingerprintAnim from '@/assets/blue-fingerprint-888-tt.svg';
...
const ScoreHero = () => {
  ...
  return (
    <svg viewBox="0 0 120 120" className="w-full h-full">
      ...
      {/* "You" label arrow on tallest bar */}
      <motion.g
...
interface ReinforcementHero888TtProps {
  type: HeroType;
}

const ReinforcementHero888Tt = ({ type }: ReinforcementHero888TtProps) => {
...
export default ReinforcementHero888Tt;
