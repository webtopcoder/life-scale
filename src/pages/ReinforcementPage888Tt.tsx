...
import ReinforcementScreen888Tt, {
  type ReinforcementScreen888TtProps,
} from '@/components/reinforcement/ReinforcementScreen888Tt';

type ScreenConfig = Omit<ReinforcementScreen888TtProps, 'onContinue'>;

/**
 * Reinforcement screens for the /onboarding-888-tt flow only.
...
const ReinforcementPage888Tt = () => {
  ...
  return (
    <ReinforcementScreen888Tt {...screen} onContinue={handleContinue} />
  );
};

export default ReinforcementPage888Tt;