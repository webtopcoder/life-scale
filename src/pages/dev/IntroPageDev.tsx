...
const IntroPageDev = () => {
  ...
  useEffect(() => {
    ...
    // Warmup already started by OnboardingDevPage boot gate
  }, []);
  ...
  const bullets = [
    '27 questions that get harder as you go',
          ...
          <div className="bg-card border border-border/50 rounded-2xl shadow-md p-6 sm:p-8 md:p-10 text-center space-y-8">
            ...
            <div className="space-y-2">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground leading-snug">
                Ready? Let's measure your <span className="text-primary/80">IQ!</span>
              </h1>
            </div>
